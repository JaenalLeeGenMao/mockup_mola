      ...
      <html className="no-js" lang="en">
        <head>
          ...
          <meta
            ...
            content={keywords ? keywords : `Mola, MolaTV, MolaSport, TV, Sport, Premiere League, ${description}`}
          />
          <meta
            name="description"
            data-react-helmet="true"
          ...
          <script
            dangerouslySetInnerHTML={{
              __html: `var initESW = function(gslbBaseURL) {
                ...
                embedded_svc.init(
                  ...
                  'Mola_TV',
                  {
                    ...
                    deploymentId: '5722v000000Q2Va',
                    buttonId: '5732v000000Q1WW',
                    baseLiveAgentURL: 'https://d.la1-c1-hnd.salesforceliveagent.com/chat',
                    eswLiveAgentDevName: 'EmbeddedServiceLiveAgent_Parent04I2v000000GtqiEAC_16d4347598b',
              ...
              if (!window.embedded_svc) {
                ...
                s.setAttribute('src', 'https://mola-support.my.salesforce.com/embeddedservice/5.0/esw.min.js');
                s.onload = function() {
                  initESW(null);
                };
