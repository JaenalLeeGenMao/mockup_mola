...
import styles from './PlatformCheckNew.css'
...
class PlatformCheckNew extends Component {
  state = {
    result: [],
  }
...
export default compose(withStyles(styles), connect(mapStateToProps, mapDispatchToProps))(PlatformCheckNew)
