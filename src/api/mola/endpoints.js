...
export const HOME_PLAYLIST_ENDPOINT = `http://localhost:3099/${endpoints.api}/videos/playlists`;
...
export const HISTORY_ENDPOINT = `http://localhost:3099/${endpoints.api}/userdata`;

export const SEARCH_ENDPOINT = `http://localhost:3099/${endpoints.api}/search/`;
export const SEARCH_GENRE_ENDPOINT = `http://localhost:3099/${endpoints.api}/videos/playlists/genre`;
export const RECENT_SEARCH_ENDPOINT = `http://localhost:3099/${SEARCH_ENDPOINT}histories`;
